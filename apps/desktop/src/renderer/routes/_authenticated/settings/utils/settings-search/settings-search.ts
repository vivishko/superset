...
export const SETTING_ITEM_ID = {
	...
	PROJECT_TERMINAL_PROXY: "project-terminal-proxy",
...
export const SETTINGS_ITEMS: SettingsItem[] = [
	...
	{
		id: SETTING_ITEM_ID.TERMINAL_PROXY,
		section: "terminal",
		title: "Terminal Proxy",
		description: "Configure inherited, manual, or disabled proxy for terminals",
		keywords: [
			"terminal",
			"proxy",
			"http_proxy",
	...
	{
		id: SETTING_ITEM_ID.PROJECT_TERMINAL_PROXY,
		section: "project",
		title: "Project Terminal Proxy",
		description: "Override global terminal proxy for this project",
		keywords: [
			"project",
			"terminal",
			"proxy",
